...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="hijab.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Hijab</a></th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($conn,"SELECT * FROM products WHERE available >='1' AND item ='hijab'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
							...
							<ul style="float: left;">
								<li style="float: left; padding: 0px 25px 25px 25px;">
									<div class="home-prodlist-img"><a href="view_product.php?pid='.$id.'">
										<img src="../image/product/hijab/'.$picture.'" class="home-prodlist-imgi">
										</a>
