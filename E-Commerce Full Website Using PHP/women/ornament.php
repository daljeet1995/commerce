...
<body>
	...
	<div class="categolis">
		<table>
			<tr>
				...
				<th><a href="ornament.php" style="text-decoration: none;color: #ddd;padding: 4px 12px;background-color: #24bfae;border-radius: 12px;">Ornament</a></th>
	...
	<div style="padding: 30px 120px; font-size: 25px; margin: 0 auto; display: table; width: 98%;">
		<div>
		<?php 
			$getposts = mysqli_query($conn,"SELECT * FROM products WHERE available >='1' AND item ='ornament'  ORDER BY id DESC LIMIT 10") or die(mysql_error());
